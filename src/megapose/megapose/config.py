...
BOP_TOOLKIT_DIR = PROJECT_DIR / "deps" / "bop_toolkit_challenge"
...
#     BLENDER_INSTALL_DIR = Path(os.environ.get("") / BLENDER_VERSION

PYTHON_BIN_PATH = Path("/usr/bin/python") 
...
os.makedirs(BLENDER_PBR_DS_DIR, exist_ok=True)
